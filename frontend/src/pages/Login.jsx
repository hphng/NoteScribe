...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="p-8 max-w-md mobile:w-[80%] w-full bg-white rounded-lg shadow-md shadow-orange-500 border-2 border-black ">
        ...
        <div className='text-gray-400 border-t-2 border-t-gray-200'>
          ...
          <div className='w-full flex flex-row justify-center gap-4'>
            ...
            <button onClick={() => window.location.href = `${import.meta.env.VITE_API_URL}/api/auth/facebook`}>
              <FontAwesomeIcon 
                icon={faFacebook} 
